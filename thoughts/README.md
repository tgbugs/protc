...
What is valuable is neither the fact nor the number, but how it came to be known.
...
Stimulang, DSL for specifying stimuli parameters, initially worked out for visual stimuli,
