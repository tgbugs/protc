...
(tag-doc 'protc:*check '(ilxtr:deprecatedTag ilxtr:measure)
         "DEPRECATED conflation of a *measure and a check against some logical condition, this may come back at some point")
(tag-doc 'protc:ambigious-error 'protc:error
         "Cases where it is not clear how two or more pieces of text are related, for example ambiguit about which one of two solutions was used.")
...
(tag-doc 'protc:internal-step '()
         "")
(tag-doc 'protc:missing-input '()
         "")
(tag-doc 'protc:missing-reference-error '()
         "")
(tag-doc 'protc:no-how-details-error '()
         "")
(tag-doc 'protc:objective '()
         "")
(tag-doc 'protc:parameter '()
         "")
